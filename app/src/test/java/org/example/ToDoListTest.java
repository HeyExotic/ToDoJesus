...
class TodoListTest {
    ...
    void testAddTask() {
        ...
        assertEquals("Go to the gym", todotestt.AllTasksTest().get(0).getDescription());
    }
    ...
    void testRemoveTask() {
        ...
        assertEquals(1, todotestt.AllTasksTest().size());
        assertEquals("Drive the car", todotestt.AllTasksTest().get(0).getDescription());
    }
    ...
    void testMarkTaskComplete() {
        ...
        assertTrue(todotestt.AllTasksTest().get(0).isComplete());
    }
    ...
    void testGetCompleteTasks() {
        ...
        assertEquals("Go to the gym", completeTasks.get(0).getDescription());
    }
    ...
    void testGetIncompleteTasks() {
      ...
      todotestt.CompleteTest(0);
        ...
        assertEquals("Drive the car", incompleteTasks.get(0).getDescription());
    }
